[![build status](https://travis-ci.org/krehator21/springboot-angular2-showtime.svg?branch=master)](https://travis-ci.org/krehator21/springboot-angular2-showtime)
